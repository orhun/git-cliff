...
GIT_COMMITTER_DATE="2022-04-06 01:25:10" git commit --allow-empty -m "This is unconventional."
GIT_COMMITTER_DATE="2022-04-06 01:25:11"  git commit --allow-empty -m \
    "This is unconventional on multiple lines.

Line 2

Some Footer: user3 <user3@example.com>
"
