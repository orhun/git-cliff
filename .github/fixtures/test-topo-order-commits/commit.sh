...
git tag v0.2.0
GIT_COMMITTER_DATE="2022-04-06 01:25:25" git commit --allow-empty -m "test: add tests"
git checkout v0.1.0
GIT_COMMITTER_DATE="2022-04-06 01:25:13" git commit --allow-empty -m "fix: fix again feature 1"
git tag v0.1.1
git checkout master
