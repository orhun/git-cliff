    ...
    fn bump_version() -> Result<()> {
        ...
        for (version, expected_version, commits) in
            [
                ...
                ("0.0.1", "0.1.0-alpha.0", vec!["feat: add xyz", "fix: fix xyz"]),
                ("0.0.1", "0.1.0-alpha.0", vec!["feat!: add xyz", "feat: zzz"]),
                ("0.1.0", "0.1.1-alpha.0", vec!["fix: fix xyz"]),
                ("0.1.0", "0.2.0-alpha.0", vec!["feat: add xyz", "fix: fix xyz"]),
                ("0.1.0", "0.2.0-alpha.0", vec!["feat!: add xyz", "feat: zzz"]),
                ("0.1.0-alpha.0", "0.1.0-alpha.1", vec!["feat!: add xyz", "feat: zzz"]),
                ("0.1.0-beta.0", "0.1.0-beta.1", vec!["feat!: add xyz", "feat: zzz"]),
            ] 
        {
            let release = build_release(version, &commits);
            let next_version = release.calculate_next_version_with_config(&Bump {
        ...
        for (version, expected_version, commits) in
            [
                ("0.1.0-alpha.0", "0.1.0-rc.0", vec!["feat!: add xyz", "feat: zzz"]),
                ("0.1.0-beta.2", "0.1.0-rc.0", vec!["feat!: add xyz", "feat: zzz"]),
            ] 
        {
            let release = build_release(version, &commits);
            let next_version = release.calculate_next_version_with_config(&Bump {
        ...
        for (version, expected_version, commits) in
            [
                ("0.1.0-alpha.0", "0.1.0", vec!["feat!: add xyz", "feat: zzz"]),
