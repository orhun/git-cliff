...
/// List of possible configuration file location. This list of files is used for finding the configuration file
/// relative to the project directory. The first file has the highest priority.
