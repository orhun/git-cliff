...
there are 2 ways of doing this, in both ways, the message is available in the context of the template under the name `message`
```
{% if message %}
    {{ message }}
{% endif %}\
...
One way of adding a version message is to add the message to the tag
