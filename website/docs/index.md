...
**git-cliff** can generate [changelog](https://en.wikipedia.org/wiki/Changelog) files from the [Git](https://git-scm.com/) history by utilizing [conventional commits](/docs/configuration/commit#parse_conventional_commits) as well as regex-powered [custom parsers](/docs/configuration/commit#commit_parsers).
